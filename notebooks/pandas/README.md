# Pandas Notebook Split

These notebooks are the smaller pandas-focused analysis parts. Each notebook repeats the setup cells it needs so you can run it independently.

- `01_data_prep_and_core_relationships.ipynb`: loading, merge, per-capita features, early relationship plots
